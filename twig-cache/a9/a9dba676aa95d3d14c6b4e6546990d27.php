...
<ul>
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "\"> ";
            echo twig_escape_filter($this->env, twig_title_string_filter($this->env, twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 12))), "html", null, true);
            echo "</a>
        ";
        }
...
";
    ...
    {
        return array (  87 => 4,  75 => 14,  64 => 12,  60 => 11,  52 => 5,  50 => 4,  46 => 3,  35 => 1,);
    }
